...
public class SellerListController implements Initializable, DataChangeListener{
	...
	@FXML
	private TableColumn<Seller, Date> tableColumnBirth;
	@FXML
	...
	private void initializeNodes() {
		...
		tableColumnBirth.setCellValueFactory(new PropertyValueFactory<>("birthDate"));
		Utils.formatTableColumnDate(tableColumnBirth, "dd/MM/yyyy");
